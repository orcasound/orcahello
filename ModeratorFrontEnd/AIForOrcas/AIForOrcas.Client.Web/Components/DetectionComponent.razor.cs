...
public partial class DetectionComponent
{
	...
	protected override async Task OnParametersSetAsync()
	{
		...
		if (!Detection.Reviewed && !ReferenceEquals(Detection, _initializedDetection))
		{
			...
			// Handle any aliases that might be generated by models.
			// Previously, PODS-AI used "resident" but we only use
			// "srkw" at present.  If we need to translate, say,
			// "transient" to "biggs" in the future, this is where
			// we would do such translations.  This intentionally
