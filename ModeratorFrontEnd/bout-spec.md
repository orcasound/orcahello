...
| Term            | Definition |
| --------------- | ---------- |
| **Detection**   | A timestamped **1-minute** acoustic observation on one node (OrcaHello: *candidate*). It may contain zero or more approximately 3-second annotation intervals reported by a model or moderator. |
